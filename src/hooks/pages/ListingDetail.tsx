          ...
          {listing.photos && listing.photos.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 gap-1 h-72">
              {listing.photos.slice(0, 5).map((photo, i) => (
                <div
                  key={i}
                  className={`overflow-hidden bg-gray-100 ${i === 0 ? "col-span-2 row-span-2" : ""}`}
                >
                  <img
                    src={photo}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              {listing.phone && (
                <a
                  ...
                  className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors"
                >
              ...
              {listing.website && (
                <a
                  ...
                  className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors md:col-span-2"
                >
                  ...
                  {listing.hours.map((h, i) => (
                    <div key={i} className="flex justify-between text-sm py-1.5 border-b border-gray-50">
                      ...
                      <span className="text-gray-500">
                        {h.open_time} {h.close_time ? `– ${h.close_time}` : ""}
                      </span>
                    </div>
                  ))}
                </div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              {listing.website && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 text-center py-3 border border-blue-600 text-blue-600 rounded-xl font-medium hover:bg-blue-50 transition-colors"
                >
                  Visit Website
                </a>
              )}
